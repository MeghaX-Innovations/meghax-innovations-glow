  ...
  const services = [
    {
      ...
      isHighlighted: true,
      color: "from-meghax-light-blue to-meghax-dark-blue",
      hoverColor: "hover:shadow-meghax-light-blue/30"
    },
    {
      icon: Code,
      ...
      isHighlighted: false,
      color: "from-meghax-light-green to-meghax-dark-green",
      hoverColor: "hover:shadow-meghax-light-green/30"
    },
    {
      icon: Smartphone,
    ...
    },
    {
      ...
      isHighlighted: true,
      color: "from-meghax-dark-blue to-meghax-dark-green",
      hoverColor: "hover:shadow-meghax-dark-blue/30"
    },
    {
      icon: Cloud,
