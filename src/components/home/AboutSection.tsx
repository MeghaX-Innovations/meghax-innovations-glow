  ...
  useEffect(() => {
    const animateFloatingTechs = () => {
      ...
      techElements.forEach((element, index) => {
        ...
        // Distribute tech bubbles more widely around the center logo
        // Calculate random distance from center (50-90% of container)
        const distance = 40 + Math.random() * 40; // 40-80% distance from center
            ...
            <div className="relative w-full h-[400px] lg:h-[500px] overflow-hidden rounded-xl">
              ...
              <div ref={animationRef} className="tech-animation absolute inset-0">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-64 h-64 rounded-full bg-gradient-to-br from-meghax-dark-blue to-meghax-light-green animate-pulse-slow flex items-center justify-center">
                    <img 
